...
public void RequestClientSteamFriends(int client)
{
	...
	HTTPRequestHandle httpRequest = CEconHTTP_CreateBaseHTTPRequest("", HTTPMethod_GET);
...
public Action Timer_QuestUpdateInterval(Handle timer, any data)
{
	...
	HTTPRequestHandle hRequest = CEconHTTP_CreateBaseHTTPRequest("", HTTPMethod_POST);
